package com.fishinwater.java_test.ui;
...
public class MyTextView extends View {
    ...
    public MyTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        // 获取自定义属性
        TypedArray array = context.obtainStyledAttributes(attrs, com.example.customview.R.styleable.TextView);

        mText = array.getString(com.example.customview.R.styleable.TextView_fiw_text);
        mTextColor = array.getColor(com.example.customview.R.styleable.TextView_fiw_textColor, mTextColor);
        mTextSize = array.getDimensionPixelSize(com.example.customview.R.styleable.TextView_fiw_textSize, mTextSize);
